                ...
                <div
                    ...
                    <div className={"games pt-[10px] flex justify-between items-center"}>
                        ...
                        <p className={"game-text font-medium text-black text-sm w-[360px]"}>Super Mario - классическая
                            игра, положившая начало целой серии. Игрок управляет Марио, который бегает, прыгает и
                            собирает предметы, чтобы преодолевать препятствия и побеждать врагов. Несмотря на простую
                            механику, игра отличалась высокой сложностью и увлекательным геймплеем. Яркая пиксельная
                            графика, запоминающаяся музыка и харизматичные персонажи сделали эту игру культовой
                            классикой своего времени. </p>
                    </div>
                </div>
